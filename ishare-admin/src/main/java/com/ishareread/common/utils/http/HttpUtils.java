package com.ishareread.common.utils.http;
...
public class HttpUtils {
	...
	public static String sendGet(String url, Map<String,String> headMap) {
		...
		try {
			...
			for (String key : headMap.keySet()) {
				String str = headMap.get(key);//得到每个key多对用value的值
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPost(String url,Map<String,String> headMap) {
		PrintWriter out = null;
		BufferedReader in = null;
		StringBuilder result = new StringBuilder();
		try {
